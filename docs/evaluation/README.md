...
このフォルダには、タイ文字ノートの仕様や実装手順ではなく、開発過程を記録・評価するための資料をまとめる。
...
| [対話添付ファイル](dialogue-assets/) | 対話中に共有された画像などの添付資料 |

## 文書の区分

- `docs/evaluation/`: 開発過程の記録、分析、品質評価に使用する資料
- `docs/`: 製品要件、技術構成、学習設計、ロードマップなど開発に直接使用する文書
- `docs/decisions/`: 開発中に決定した方針とその理由
